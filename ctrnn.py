...
class CTRNN():
    ...
    def randomizeParameters(self,r):
        self.Weights = np.random.uniform(-r,r,size=(self.Size,self.Size))
        self.Biases = np.random.uniform(-r,r,size=(self.Size))
